...
metadata_path = "./custom_dataset/custom_test_dataset.csv"
metadata = pd.read_csv(metadata_path)
image_directory = "./custom_dataset/test_images"
family_list, family_to_person_map, person_to_image_map = parsing(metadata)

# 최종 데이터 세트가 담길 폴더 생성
positive_folder = "./custom_dataset/fixed_test_dataset/positive"
if not os.path.exists(positive_folder):
    os.makedirs(positive_folder)
negative_folder = "./custom_dataset/fixed_test_dataset/negative"
